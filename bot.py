...
def callback(call):
    ...
    if call.data == "buy":
        ...
        bot.send_message(call.message.chat.id,
                         "ℹ️ Biz haqimizda:\n\n"
                         "Xurmatli mijoz CoMETA Uc botidan foydalanatotganingizda soxta chek yubormang aka holda Uc yoq qoidalarga amal qiling\n"
...
def uc_select(call):
    ...
    bot.send_message(call.message.chat.id,
                     "💳 To‘lov qiling Tolov turi UZCARD:\n8600060964894142 SATTAROV ISMAILJANn\n"
                     "📸 Chek yuboring")
...
def approve(call):
    ...
    bot.send_message(user_id,
                     "🎉UC hisobingizga tushdi!\nRahmat bizni tanlaganiz uchun ❤️")
