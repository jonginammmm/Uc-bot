...
def callback(call):
    ...
    if call.data == "price":
        ...
        bot.send_message(call.message.chat.id, "🎮 PUBG NIK VA ID KIRITING :")
        ...
        bot.send_message(call.message.chat.id,
                         ...
                         "🔥 Eng yaxshi va Arzon Uc narxlar Kattaro UC paket kere bosa adminga✍️")
        ...
        bot.send_message(call.message.chat.id,
                         "💳 To‘lov qiling Tolov Turi UZCARD VISA:\n860060964894142 4278320021238612\n\n📸 Chek yuboring")
