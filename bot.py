...
def cb(c):
    ...
    try:
        if c.data=="prices":
            ...
            bot.edit_message_text(f"👤 ID: {uid}\n💰 Balans: {bal}",c.message.chat.id,c.message.message_id,reply_markup=menu())
elif c.data=="about":
...
3. PUBG ID va NIKni to‘g‘ri kiriting
4. Admin tez javob berishga harakat qiladi biroz kechiksa vohima qb tashameng
5. Chek ko‘rib UC tashlanadi
6. Biz sizni aldamaymiz — Bizga ishonch muhim!
