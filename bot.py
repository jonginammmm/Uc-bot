...
TOKEN = "8716951130:AAEKmXgRH-4tiCeyOdO5y8CS6W5pY9HoHTg"
ADMIN_ID = 6394219796
...
def call(c):
    ...
    if c.data == "back":
        ...
        msg = bot.send_message(uid,"🎮 PUBG ID kiriting xato bolsa qolganiga Bot javob bermaydi ID togri kiriting:",reply_markup=back())
